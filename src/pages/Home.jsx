			...
			<div className="home">
				<div className="hero">
					...
					<div className="main-hero">
						...
						<p
							...
							data-aos-duration="1000"
						>
							Energized and engaged in moving foward as a team to get the job
							done right, every time,providing outstanding client
				...
				<section className="section-1">
					...
					<div className="section-1-text">
						...
						provides outstanding expertise and infrastructure to support the
						most diverse range of services from well service ,mechanical & civil
						construction etc. Whatever we operate we stand by our clients, and
						the work we do.
					</div>
				...
				<section className="section-4">
					...
					<Link to="/projects">
						<button type="button" className="custom-btn btn-13 btn-3">
							<span>See All</span>
						</button>
					</Link>
				</section>
